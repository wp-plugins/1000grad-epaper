...
<?php if(isset($this->oView->channelobject)): ?>
    ...
    <?php if(!$this->oView->bAgbWasAccepted): ?>
        <div id="tg_epaper_agb_overlay">
            <div id="tg_epaper_agb_check_content" class="tg-border-radius">
                ...
                <div>
                <a id="agb_accept_button" class="tg_cancel_upload button_blue"><?php _e('Accept','1000grad-epaper') ?></a>
                <a href="<?php echo $this->oView->sAdminUrl ?>" class="tg_cancel_upload button_blue"><?php _e('Cancel','1000grad-epaper') ?></a>
                </div>
            </div>
        </div>
    <?php endif; ?>
    ...
    <input type="hidden" id="tg_channels_clear_channel" value="<?php _e("Are you sure? The current ePaper will be deleted!",'1000grad-epaper') ?>"/>
    <input type="hidden" id="tg_channels_new_upload" value="<?php _e("Are you sure? The current ePaper will be overwritten!",'1000grad-epaper') ?>"/>
<?php endif; ?>
