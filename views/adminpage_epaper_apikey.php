...
<div class='tg_info_box tg_box'>
    <div class='tg_info_box_inner'>
        <div class="tg_info_box_inner_header"><?php _e("Request 1000°ePaper Key","1000grad-epaper") ?></div>
        <div class='tg_info_box_inner_content'>
            <form action="" method="post">
                ...
                <?php _e('I have read the <a target="_blank" href="http://www.1000grad.de/upload/Dokumente/agb/SaaSAgreement-TCen-2013-07-26.pdf">terms of use</a> and I agree.', '1000grad-epaper'); ?><br />
                <input type="checkbox" name="newsletter" value="yes" checked>
                <?php _e('I want to receive newsletters from 1000°DIGITAL GmbH.', '1000grad-epaper'); ?><br />
                ...
                <div class="metabox-prefs">          
                    <form action="" method="get">
                        <table>
                            ...
                            <tr>
                                <td>
                                    <label for="code"><?php _e("1000° ePaper WP-Key", "1000grad-epaper"); ?>:</label>    
                                </td>
                                <td>
...
<div class='tg_info_box tg_box'>
    <div class='tg_info_box_inner'>
        ...
        <div class='tg_info_box_inner_content'>
            ...
            <p>
                <a href=mailto:info@epaper-apps.1000grad.com>info@epaper-apps.1000grad.com</a><br />
                <a href=http://epaper-apps.1000grad.com/>http://epaper-apps.1000grad.com/</a><br />
